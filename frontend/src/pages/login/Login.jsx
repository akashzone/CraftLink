...
const Login = () => {
  const handleSubmit = (e) => {
    e.preventDefault();
    // UI only - no submission logic as requested
  };
    ...
    <div className="login-page">
      <div className="login-card">
        <div className="login-card-header">
          ...
          <h1 className="login-title">Sign in to CraftLink</h1>
        </div>
        ...
        <button className="btn btn-secondary btn-block google-signin-btn">
        ...
        <div className="login-card-footer">
          ...
          <Link to="/register" className="register-link">Join CraftLink</Link>
        </div>
      </div>
    </div>
  );
